...
// Todo lo que antes vivía directo en Dashboard.jsx para la seccion de
// credenciales, extraído tal cual (mismo comportamiento) para que Dashboard
// pueda alternar entre esto y TokensPanel. El nav/header y el modal de
// cambio de master password se quedan en Dashboard porque son de la cuenta,
// no de una seccion en particular.
